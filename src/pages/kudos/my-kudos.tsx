...
const myReceivedKudos = [
  {
    ...
    category: 'Excellence',
    message: 'Your dedication to quality code and attention to detail has greatly improved our product. The refactoring you did last week made the application much more maintainable!',
  ...
  },
  {
    ...
    teamName: 'Engineering',
    category: 'Teamwork',
    message: 'Thank you for staying late to help me debug that critical issue. Your collaborative spirit and technical expertise saved the day!',
...
const myGivenKudos = [
  {
    ...
    teamName: 'Design',
    category: 'Innovation',
    message: 'Your redesign of the dashboard is absolutely stunning! The new layout is both beautiful and functional, making complex data easy to understand.',
    createdBy: 'You',
  ...
  },
  {
    ...
    teamName: 'Product',
    category: 'Leadership',
    message: 'Your leadership during the last sprint was exceptional. You kept everyone focused and motivated even when we faced unexpected challenges.',
    createdBy: 'You',
