...
const Header = () => {
  ...
  return (
    <header className="backdrop-blur-md bg-white/80 border-b border-gray-100 sticky top-0 z-30 shadow-sm">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="hidden md:flex items-center px-4 py-2 text-gray-700 bg-gray-100 hover:bg-gray-200 transition-colors rounded-lg font-medium"
            >
              Login
            </motion.button>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <nav className="flex flex-col space-y-3">
              ...
              <button className="text-left text-gray-700 hover:text-indigo-600 font-medium transition-colors px-2 py-1">
                Login
              </button>
            </nav>
          </motion.div>
